...
function checkLogIn() {
    ...
    checkCorrectCredentials(emailInput, passwordInput);
    if (isLoggedIn) return;
    wrongCredentials(passwordInput);
}

/** 
 * Shows alert message when used wrong credentials. 
 */
function wrongCredentials(passwordInput) {
...
/** 
 * Checks the correct credentials and redirects user to Summary-Page. 
 */
function checkCorrectCredentials(emailInput, passwordInput) {
