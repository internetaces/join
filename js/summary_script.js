...
function addClassMobile() {
    ...
    showAndHideMobileMessage(messageContainer);
}

/**
 * Ads classes for mobile animation of welcome message. 
 */
function showAndHideMobileMessage(messageContainer) {
...
function sortCardsPrioHigh() {
    ...
    if (!(upComingDeadline && upComingDeadlineTitle)) return;
